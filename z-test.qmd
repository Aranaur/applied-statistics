...
dnrom = norm.pdf(2, loc=mu, scale=sigma)
pnorm = norm.cdf(2, loc=mu, scale=sigma)
qnorm = norm.ppf(0.977, loc=mu, scale=sigma)
...
# CDF for 2
plt.fill_between(x, norm.pdf(x, loc=mu, scale=sigma), where=(x <= 2), color=turquoise, alpha=0.2)
plt.annotate('norm.cdf(2) = 0.977', xy=(1, 0.15), xytext=(1.5, 0.3), color=turquoise,
             arrowprops=dict(facecolor=turquoise, shrink=0.05))

# PDF for 2
plt.scatter(qnorm, norm.pdf(qnorm, loc=mu, scale=sigma), color=orange, s=15, zorder=5)
plt.plot([2, 2], [0, dnrom], color=orange, linewidth=1, linestyle='--')
plt.annotate('norm.pdf(2) = 0.054', xy=(2, dnrom), xytext=(2.5, 0.2), color=orange, ha = 'center',
             arrowprops=dict(facecolor=orange, shrink=0.05))


# PPF for 0.977
plt.scatter(qnorm, 0, color=purple, label='qnorm(0.977)', s=15, zorder=5)
plt.annotate('norm.ppf(0.977) = 2', xy=(qnorm, 0), xytext=(2.5, 0.1), color=purple, ha = 'left',
